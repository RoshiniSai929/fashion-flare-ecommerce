      ...
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm ">
        <div className="">
          ...
          <p className="w-full sm:w-2/3 text-gray-600">
            Shop with FashionFlare and experience the convenience of online shopping
            like never before.
          </p>
        </div>
        ...
        <div className="">
          ...
          <ul className="flex flex-col flex-1 text-gray-600">
            ...
            <li className="mb-2">contact@FashionFlare.com </li>
          </ul>
        </div>
      </div>
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright 2025@ FashionFlare.com - All Rights Reserved
        </p>
      </div>
    </div>
  );
